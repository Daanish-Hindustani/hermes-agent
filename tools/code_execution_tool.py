...
Lets the LLM write a Python script that calls ProteinClaw tools via RPC,
...
"""Auto-generated ProteinClaw tools RPC stubs."""
...
"""Auto-generated ProteinClaw tools RPC stubs (file-based transport)."""
...
def execute_code(
    ...
    to a subset of ProteinClaw tools.
    ...
    try:
        ...
        # HERMES_TIMEZONE is an internal ProteinClaw setting and must not leak
...
def build_execute_code_schema(enabled_sandbox_tools: set = None,
    ...
    description = (
        "Run a Python script that can call ProteinClaw tools programmatically. "
