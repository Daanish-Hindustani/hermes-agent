"""ACP session manager — maps ACP sessions to ProteinClaw AIAgent instances.
...
@dataclass
class SessionState:
    """Tracks per-session state for an ACP-managed ProteinClaw agent."""
...
class SessionManager:
    """Thread-safe manager for ACP sessions backed by ProteinClaw AIAgent instances.
    ...
    def __init__(self, agent_factory=None, db=None):
        ...
        Args:
            agent_factory: Optional callable that creates an AIAgent-like object.
                           ...
                           using the current ProteinClaw runtime provider configuration.
