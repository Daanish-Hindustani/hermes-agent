#!/usr/bin/env python3
"""
SWE Runner with ProteinClaw Trajectory Format

A runner that uses ProteinClaw-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the ProteinClaw-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses ProteinClaw-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in ProteinClaw format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches ProteinClaw-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using ProteinClaw-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with ProteinClaw Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses ProteinClaw-Agent's built-in execution environments
    and outputs trajectories in ProteinClaw-Agent format.
    """
    ...
    def _convert_to_hermes_format(
        ...
        """
        Convert internal message format to ProteinClaw trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to ProteinClaw trajectory format
...
def main(
    ...
    """
    Run SWE tasks with ProteinClaw trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with ProteinClaw Trajectory Format")
    print("=" * 60)
