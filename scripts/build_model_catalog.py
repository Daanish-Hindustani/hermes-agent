#!/usr/bin/env python3
"""Build the ProteinClaw Model Catalog — a centralized JSON manifest of curated models.
...
ProteinClaw CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a ProteinClaw release.
