"""
Timezone-aware clock for ProteinClaw.
...
Invalid timezone values log a warning and fall back safely — ProteinClaw never
...
try:
    ...
    # Python 3.8 fallback (shouldn't be needed — ProteinClaw requires 3.9+)
