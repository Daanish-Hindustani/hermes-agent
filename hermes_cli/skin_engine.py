"""ProteinClaw CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "ProteinClaw"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ ProteinClaw "       # Response box header label
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "ProteinClaw"
...
- ``default`` — Classic ProteinClaw gold/kawaii (the current look)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic ProteinClaw — gold and kawaii",
        "colors": {
        ...
        "branding": {
            "agent_name": "ProteinClaw",
            "welcome": "Welcome to ProteinClaw! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ ProteinClaw ",
            "prompt_symbol": "❯",
