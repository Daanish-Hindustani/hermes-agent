"""``hermes debug`` — debug tools for ProteinClaw.
...
⚠️  This will upload the following to a public paste service:
  • System info (OS, Python version, ProteinClaw version, provider, which API keys
...
def run_debug_share(args):
    ...
    print(f"\nShare these links with the ProteinClaw team for support.")
