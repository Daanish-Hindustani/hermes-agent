"""
Single source of truth for provider identity in ProteinClaw.
...
2. **ProteinClaw overlays** — transport type, auth patterns, aggregator flags,
...
# -- ProteinClaw overlay ----------------------------------------------------------
# ProteinClaw-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class HermesOverlay:
    """ProteinClaw-specific provider metadata layered on top of models.dev."""
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    Resolution order:
      1. ProteinClaw overlays (for providers not in models.dev: nous, openai-codex, etc.)
      2. models.dev catalog + ProteinClaw overlay
    ...
    if overlay is not None:
        # ProteinClaw-only provider (not in models.dev)
        return ProviderDef(
            id=canonical,
