...
def remove_path_from_shell_configs():
    """Remove ProteinClaw PATH entries from shell configuration files."""
    ...
    for config_path in configs:
        try:
            ...
            for line in content.split('\n'):
                # Skip the "# ProteinClaw" comment and following line
                if '# ProteinClaw' in line or '# hermes-agent' in line:
                    skip_next = True
                    continue
...
def run_uninstall(args):
    ...
    print(color("│            ⚕ ProteinClaw Uninstaller                  │", Colors.MAGENTA, Colors.BOLD))
    print(color("└─────────────────────────────────────────────────────────┘", Colors.MAGENTA, Colors.BOLD))
    print()
    ...
    print()
    if full_uninstall:
        print(color("⚠️  WARNING: This will permanently delete ALL ProteinClaw data!", Colors.RED, Colors.BOLD))
        ...
        print("This will remove the ProteinClaw code but keep your configuration and data.")
    ...
    print()
    print("Thank you for using ProteinClaw! ⚕")
    print()
