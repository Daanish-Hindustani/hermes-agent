...
TIPS = [
    ...
    "Ctrl+Z suspends ProteinClaw to the background — run fg in your shell to resume.",
    ...
    "hermes mcp serve runs ProteinClaw itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire ProteinClaw home directory.",
    ...
    "hermes gateway install sets up ProteinClaw as a system service (systemd/launchd).",
    ...
    # --- Tools & Capabilities ---
    "execute_code runs Python scripts that call ProteinClaw tools programmatically — results stay out of context.",
    ...
    "When exiting, ProteinClaw prints a resume command with session ID and stats.",
    ...
    # --- Gateway & Messaging ---
    "ProteinClaw runs on 18 platforms: Telegram, Discord, Slack, WhatsApp, Signal, Matrix, email, and more.",
    ...
    "BlueBubbles brings iMessage to ProteinClaw via a local macOS server.",
    ...
    "ProteinClaw loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    "hermes acp runs ProteinClaw as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "SOUL.md completely replaces the agent's default identity — rewrite it to make ProteinClaw your own.",
    ...
    "Before a gateway session reset, ProteinClaw auto-flushes important facts to memory in the background.",
