"""Slash command definitions and autocomplete for the ProteinClaw CLI.
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of ProteinClaw config/state", "Session",
    ...
    CommandDef("busy", "Control what Enter does while ProteinClaw is working", "Configuration",
    ...
    CommandDef("update", "Update ProteinClaw to the latest version", "Info",
               gateway_only=True),
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to ProteinClaw or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
