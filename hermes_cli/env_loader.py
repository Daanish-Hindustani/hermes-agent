"""Helpers for loading ProteinClaw .env files consistently across entrypoints."""
...
def _sanitize_env_file_if_needed(path: Path) -> None:
    ...
    already knows all valid ProteinClaw env-var names and can split
...
def load_hermes_dotenv(
    *,
    ...
    """Load ProteinClaw environment files with user config taking precedence.
