...
DEFAULT_AGENT_IDENTITY = (
    "You are ProteinClaw, an intelligent AI assistant created by Nous Research. "
...
HERMES_AGENT_HELP_GUIDANCE = (
    "If the user asks about configuring, setting up, or using ProteinClaw "
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot ProteinClaw itself — its CLI, config, models, providers, tools, "
