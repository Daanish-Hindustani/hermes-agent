...
# ---------------------------------------------------------------------------
# Provider ID mapping: ProteinClaw ↔ models.dev
# ---------------------------------------------------------------------------

# ProteinClaw provider names → models.dev provider IDs
...
# Reverse mapping: models.dev → ProteinClaw (built lazily)
...
def _get_provider_models(provider: str) -> Optional[Dict[str, Any]]:
    """Resolve a ProteinClaw provider ID to its models dict from models.dev.
...
# Gemma models whose TPM quotas are too small for normal ProteinClaw agent traffic.
...
def get_provider_info(provider_id: str) -> Optional[ProviderInfo]:
    ...
    Accepts either a ProteinClaw provider ID (e.g. "kilocode") or a models.dev
    ID (e.g. "kilo").  Returns None if the provider is not in the catalog.
    """
    # Resolve ProteinClaw ID → models.dev ID
...
def get_model_info(
    ...
    Accepts ProteinClaw or models.dev provider ID.  Tries exact match then
