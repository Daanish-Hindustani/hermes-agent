...
Uses the same <tool_call> format as ProteinClaw.
...
class QwenToolCallParser(HermesToolCallParser):
    ...
    Same <tool_call>{"name": ..., "arguments": ...}</tool_call> format as ProteinClaw.
    """

    pass  # Identical format -- inherits everything from ProteinClaw
